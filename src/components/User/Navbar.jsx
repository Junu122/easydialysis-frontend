...
const Navbar = () => {
  ...
  console.log(isAuthenticated,"isauthenticated in navbar") // Get auth state from Redux
        ...
        >
          <ul className="flex flex-col md:flex-row items-center gap-6">
            <NavLink to={"/"} className={activeStyleCallback}>
              <li className="py-1 font-semibold linkeffect hover:text-primary transition duration-500 ease-in-out text-[20px]">
                HOME
              </li>
          ...
          {!isAuthenticated ? (
            ...
            >
              ...
              {dropdown && (
                <div className="relative w-full md:absolute right-0 mt-2 md:w-52 bg-white shadow-lg rounded-md overflow-hidden z-10">
